...
const Form = (props) => {
  ...
  useEffect(() => {
    ...
    fetchData();
}, [accountBalance, isCreditSalaryValid, uniqueBillPayments, creditCardSpent]);
...
const handleCalculateSave = async () => {
  try {
    const airtableURL = 'https://api.airtable.com/v0/appETAOnMCK006o6N/InterestCalculator';
  ...
  return (
    <div className={styles.formContainer}>
      ...
      <div className={style.calculateContainer}>
        <Calculate accountBalance={accountBalance} annualAmount={annualAmount} monthlyAmount={monthlyAmount} onSave={handleCalculateSave} />
      </div>
    </div>
  );
};
